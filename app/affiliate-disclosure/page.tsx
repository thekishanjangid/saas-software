export default function AffiliateDisclosurePage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <h1 className="text-4xl font-bold text-slate-900 mb-8">Affiliate Disclosure</h1>
      <div className="prose prose-slate max-w-none bg-yellow-50 p-8 rounded-xl border border-yellow-200">
        ...
        <p>
          <strong>This does not affect our reviews and comparisons.</strong> We try our best to keep things fair and balanced, in order to help you make the best choice for you.
        </p>
      </div>
    </div>
  );
